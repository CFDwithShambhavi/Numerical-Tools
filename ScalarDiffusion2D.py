...
# Grid parameters:
nx = 40+2 # since this is a Finite Volume implementation, provide +2 nodes than the actual nodes you want in your computational domain
ny = 40+2 # these extra nodes are "ghost nodes" and will be used for Boundary Condition implmentation
lx = 100
ly = lx
dx = lx / nx
dy = ly / ny
...
file_name = '/scalarData'
path_name = os.getcwd()


solve_Temperature2D(K,Cp,rho,ny,nx,dx,dy,left,top,right,bottom,file_name,path_name,T_ini,dt,nt,save_t)
